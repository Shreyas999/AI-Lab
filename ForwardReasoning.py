...
def main():
    ...
    clauses.append(aima.utils.expr("(American(x) & Weapon(y) & Sells(x, y, z) & Enemy(z,America)) ==> Criminal(x)"))
    ...
    #clauses.append(aima.utils.expr('Enemy(Coco, America)'))
    #clauses.append(aima.utils.expr('Enemy(Jojo, America)'))
    #clauses.append(aima.utils.expr("Enemy(x, America) ==> Hostile(x)"))
